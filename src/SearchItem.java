...
public class SearchItem extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        ok.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/search.gif"))); // NOI18N
        ok.setText("SEARCH");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(sbi, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(sbn, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)))
...
try {
                 ...
                 DC1 dce = new DC1("select * from Item_Master where Item_no like '"+sbn.getText()+"%'");
                 data = dce.getData();
                 header = new Vector<String>();
       header.add("Item No");
       header.add("Item Name");
...
private void sbiKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sbiKeyReleased
   ...
   String s=sbi.getText();
    ...
    try {
                 ...
                 DC1 dce = new DC1("select * from Item_Master where Item_name like '"+sbi.getText().trim()+"%'");
                 data = dce.getData();
                 header = new Vector<String>();
       header.add("Item No");
       header.add("Item Name");
    ...
    private void sbnKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sbnKeyPressed
        int key=evt.getKeyCode();
    if(key==38)
    {
     sbi.requestFocus();
