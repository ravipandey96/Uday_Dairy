...
public class ChangePassword extends javax.swing.JInternalFrame {
  ...
  try{
    ...
    private void initComponents() {
        ...
        eop.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        CANCLE.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/APPLICATION ICONS/24x24-free-button-icons/gif/24x24/36.gif"))); // NOI18N
        ...
        enp.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                enpKeyPressed(evt);
            }
        });
        ...
        enp1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                enp1KeyPressed(evt);
            }
        });
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/change password.jpg"))); // NOI18N
...
// TODO add your handling code here:
    ...
    private void eopKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_eopKeyPressed
    ...
    }//GEN-LAST:event_eopKeyPressed

    private void enpKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_enpKeyPressed
     int key=evt.getKeyCode();
    if(key==38)
    {
     eop.requestFocus();
    ...
    }//GEN-LAST:event_enpKeyPressed

    private void enp1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_enp1KeyPressed
        int key=evt.getKeyCode();
    if(key==38)
    {
     enp1.requestFocus();
