...
private void sbn1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sbn1KeyReleased
 ...
 try {
                 ...
                 DBEngine dbe = new DBEngine("select * from Customer_Master where Customer_no like '"+sbn1.getText().trim()+"%'");
                 data = dbe.getData();
                 header = new Vector<String>();
       header.add("customer no");
       header.add("Customer Name");
...
// TODO add your handling code here:
    ...
    private void sbn1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sbn1KeyPressed
        int key=evt.getKeyCode();
    if(key==38)
    {
     sbn.requestFocus();
